...
export default function AllScholarships() {
    ...
    return (
        <div className="p-6 space-y-12 max-w-7xl mx-auto">
            ...
            {/* Error State */}
            {isError && (
                <p className="text-red-500 text-center">Failed to load scholarships. Try again.</p>
            )}
                ...
                {!isLoading &&
                    filteredScholarships.map((sch) => (
                        ...
                        >
                            ...
                            {/* Scholarship Info */}
                            <h2 className="text-xl font-bold mb-1 text-gray-800 hover:text-blue-600 transition-colors">
                                {sch.universityName}
                            </h2>
                            ...
                            <p className="text-gray-500 mb-1">Application Fees: ${sch.applicationFees || 0}</p>
